...
const projects: SiteMessages["projects"] = [
  ...
  {
    slug: "kellerlicht",
    title: "Kellerlicht - Weinbar cinematográfica",
    type: "Weinbar",
    href: "/demos/kellerlicht",
    group: "template",
    blurb:
      "Landing cinematográfica: vídeo scroll, Am Glas, horarios y WhatsApp.",
  },
  {
    slug: "villa-italia",
  ...
  {
    slug: "vaultshield",
    title: "VaultShield - Gestor de contraseñas",
    type: "SaaS · Landing",
    href: "/demos/vaultshield",
    group: "saas",
    blurb:
      "Hero de producto: vídeo a pantalla completa, menú lateral en móvil y animaciones de entrada.",
  },
  {
    slug: "novaai",
    title: "NovaAI - Landing cinematográfica",
    type: "SaaS · Landing",
    href: "/demos/novaai",
    group: "saas",
    blurb:
      "Sustituye el pitch de Lugner City: vídeo ligado al scroll, cristal esmerilado y tipografía editorial.",
  },
];
...
export const esMessages: SiteMessages = {
  ...
  work: {
    ...
    saasTitle: "Conceptos SaaS",
    saasLead:
      "Landings de producto digital: vídeo, animación y un solo mensaje claro.",
    open: "Abrir",
  ...
  projectsForHome: projects.map((p) => {
    ...
    if (p.slug === "kellerlicht") {
      return {
        ...p,
        blurb:
          "Plantilla weinbar: Am Glas, horarios y reserva por WhatsApp en un flujo simple.",
      };
    }
    return p;
  }),
