...
export const metadata: Metadata = {
  title: "Stadtgalerie West — Redesign Konzept",
  description:
    "Konzept / Redesign-Vorschlag — fiktives Einkaufszentrum, keine offizielle Website.",
...
const transit = [
  ...
  { line: "48A", stop: "Westbahnhof · Felberstraße" },
  { line: "6 / 18", stop: "Burggasse / Stadthalle" },
  { line: "9 / 49", stop: "Urban-Loritz-Platz" },
];

export default function StadtgalerieDemoPage() {
  const theme = getDemoTheme("stadtgalerie");

  return (
    <DemoShell themeId="stadtgalerie">
      <DemoHero
        variant="compact"
        imageSrc={HERO}
        imageAlt="Stadtansicht — Einkaufszentrum Wien"
        eyebrow="Wien 15 · Konzept"
        title="Stadtgalerie West"
      ...
      >
        <div className="mx-auto max-w-[var(--demo-max)]">
          <p className="demo-eyebrow text-[10px] opacity-75">
            Konzept — fiktives Zentrum, nicht offiziell
          </p>
          <DemoMetricsStrip
            benchmark={stadtgalerieBenchmark}
            labels={{
              metricsTitle: "",
              metricsSource: "",
              metricsBefore: "",
      ...
      <main>
        ...
        >
          <div className="mx-auto max-w-[var(--demo-max)] px-5 py-16 sm:px-8 md:py-24">
            ...
            <p className="demo-text-muted mt-3 max-w-lg text-[15px]">
              Typische Mall-Kategorien — im Relaunch mit Suche und Filter.
            </p>
        ...
        >
          <div className="mx-auto max-w-[var(--demo-max)] px-5 py-16 sm:px-8 md:py-24">
            ...
            <ul
              className="relative mt-10 ml-3 space-y-0 border-l-2 pl-8 sm:ml-4"
            ...
            <div className="demo-map mt-10 min-h-[18rem] w-full">
              <iframe
                title="Karte Wien 15 · Westbahnhof"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                src="https://maps.google.com/maps?q=Westbahnhof+Wien&t=&z=15&ie=UTF8&iwloc=&output=embed"
              />
            </div>
          </div>
        </section>
        ...
        >
          <div className="mx-auto max-w-[var(--demo-max)]">
            ...
            <p className="mt-5 font-medium">Stadtgalerie West GmbH</p>
            <p className="mt-3 max-w-md text-[15px] leading-relaxed opacity-85">
              Wien 15 · Konzept-Adresse
              <br />
              Tel:{" "}
              <a href="tel:+431234567" className="underline underline-offset-2">
                01 234 567
              </a>
              <br />
              Email:{" "}
              <a
                href="mailto:info@stadtgalerie-west.example"
                className="underline underline-offset-2"
              >
                info@stadtgalerie-west.example
              </a>
            </p>
